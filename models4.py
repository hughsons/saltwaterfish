...
class CustomersOld(models.Model):
    contactid = models.IntegerField(primary_key=True)
    billing_firstname = models.CharField(max_length=150, blank=True)
    billing_lastname = models.CharField(max_length=150, blank=True)
    billing_address = models.CharField(max_length=765, blank=True)
...
class TempRewards(models.Model):
    customer = models.CharField(max_length=765, db_column='Customer', blank=True) # Field name made lowercase.
    order_counts = models.FloatField(null=True, db_column='Order Counts', blank=True) # Field renamed to remove spaces. Field name made lowercase.
    loyalty_eligible = models.FloatField(null=True, db_column='Loyalty_Eligible', blank=True) # Field name made lowercase.
    loyalty_level_(eligible_orders) = models.CharField(max_length=765, db_column='Loyalty Level (Eligible Orders)', blank=True) # Field renamed to remove spaces. Field name made lowercase.
    loyalty_level_(all_orders) = models.CharField(max_length=765, db_column='Loyalty Level (all orders)', blank=True) # Field renamed to remove spaces. Field name made lowercase.
    class Meta:
        db_table = u'_temp_rewards'

class AdminMenu(models.Model):
    id = models.IntegerField(primary_key=True)
    menid = models.IntegerField(null=True, blank=True)
    menu_text = models.CharField(max_length=150, blank=True)
    menu_url = models.CharField(max_length=765, blank=True)
    menu_parent = models.IntegerField(null=True, blank=True)
    sorting = models.IntegerField(null=True, blank=True)
    hide = models.IntegerField(null=True, blank=True)
    class Meta:
        db_table = u'admin_menu'
...
class CustomersContact(models.Model):
    id = models.IntegerField(primary_key=True)
    userid = models.IntegerField(null=True, blank=True)
    user_firstname = models.CharField(max_length=150, blank=True)
    user_lastname = models.CharField(max_length=150, blank=True)
    user_phone = models.CharField(max_length=150, blank=True)
    user_email = models.CharField(max_length=450, blank=True)
    user_address = models.CharField(max_length=150, blank=True)
    user_city = models.CharField(max_length=150, blank=True)
    user_state = models.CharField(max_length=150, blank=True)
    user_zip = models.CharField(max_length=150, blank=True)
    ...
    class Meta:
        db_table = u'customers_contact'

class CustomersPmntprofiles(models.Model):
    contactid = models.IntegerField(null=True, blank=True)
    custprofileid = models.CharField(max_length=150, db_column='custProfileId', blank=True) # Field name made lowercase.
    custpmntprofileid = models.CharField(max_length=150, db_column='custPmntProfileId', blank=True) # Field name made lowercase.
    cardlastdigits = models.CharField(max_length=60, blank=True)
    cardexp = models.CharField(max_length=60, blank=True)
    datecreated = models.DateTimeField(null=True, blank=True)
    class Meta:
        db_table = u'customers_pmntprofiles'

class DatabaseFeeds(models.Model):
    id = models.IntegerField(primary_key=True)
    page_id = models.IntegerField(null=True, blank=True)
    feed_title = models.CharField(max_length=450, blank=True)
    feed_shortdescription = models.CharField(max_length=750, blank=True)
    feed_description = models.TextField(blank=True)
    feed_sorting = models.IntegerField(null=True, blank=True)
    feed_created = models.DateTimeField(null=True, blank=True)
    feed_expires = models.DateTimeField(null=True, blank=True)
    feed_author = models.CharField(max_length=150, blank=True)
    feed_additionalfield1 = models.CharField(max_length=450, blank=True)
    feed_additionalfield2 = models.CharField(max_length=450, blank=True)
    feed_additionalfield3 = models.CharField(max_length=450, blank=True)
    feed_additionalfield4 = models.CharField(max_length=450, blank=True)
    feed_additionalfield5 = models.CharField(max_length=450, blank=True)
    class Meta:
        db_table = u'database_feeds'
...
class ErrorLog(models.Model):
    id = models.IntegerField(primary_key=True)
    error_id = models.CharField(max_length=765, blank=True)
    error_date = models.DateTimeField(null=True, blank=True)
    userip = models.CharField(max_length=765, blank=True)
...
class ProductShippingCategories(models.Model):
    ...
    createdate = models.CharField(max_length=150, blank=True)
    class Meta:
...
class PromotionsBackup(models.Model):
    id = models.IntegerField(primary_key=True)
    promotion_name = models.CharField(max_length=450, blank=True)
    promotion_description = models.TextField(blank=True)
    promotion_start = models.DateTimeField(null=True, blank=True)
    ...
    rules_retailprice = models.IntegerField(null=True, blank=True)
    class Meta:
        db_table = u'promotions_backup'

class PromotionsExcludelist(models.Model):
    id = models.IntegerField(primary_key=True)
    promoid = models.IntegerField(null=True, blank=True)
    country = models.CharField(max_length=150, blank=True)
    state = models.CharField(max_length=150, blank=True)
    class Meta:
        db_table = u'promotions_excludelist'

class PromotionsMultiusebackupSept2012V1(models.Model):
    id = models.IntegerField()
    promotion_name = models.CharField(max_length=450, blank=True)
    promotion_description = models.TextField(blank=True)
    promotion_start = models.DateTimeField(null=True, blank=True)
    ...
    rules_retailprice = models.IntegerField(null=True, blank=True)
    class Meta:
        db_table = u'promotions_multiusebackup_sept2012v1'

class PromotionsSingleusebackupOct2012V12Ndupdate(models.Model):
    id = models.IntegerField()
    promotion_name = models.CharField(max_length=450, blank=True)
    promotion_description = models.TextField(blank=True)
    promotion_start = models.DateTimeField(null=True, blank=True)
    ...
    rules_retailprice = models.IntegerField(null=True, blank=True)
    class Meta:
        db_table = u'promotions_singleusebackup_oct2012v1_2ndupdate'
...
class ShippingCategory(models.Model):
    ...
    priority_shipping = models.IntegerField(null=True, blank=True)
    saturday_delivery = models.IntegerField(null=True, blank=True)
    alaska_delivery = models.IntegerField(null=True, blank=True)
...
class ShippingCategoryOld(models.Model):
    id = models.IntegerField(primary_key=True)
    ship_categoryname = models.CharField(max_length=600, blank=True)
    status = models.CharField(max_length=150, blank=True)
    createddate = models.CharField(max_length=150, blank=True)
    class Meta:
        db_table = u'shipping_category_old'
...
class SiteBanners(models.Model):
    ...
    banner_type = models.CharField(max_length=300, blank=True)
...
class SqlLog(models.Model):
    id = models.IntegerField(primary_key=True, db_column='ID') # Field name made lowercase.
    user = models.CharField(max_length=150, db_column='USER', blank=True) # Field name made lowercase.
    logdate = models.DateTimeField(null=True, db_column='LOGDATE', blank=True) # Field name made lowercase.
    sql = models.TextField(db_column='SQL', blank=True) # Field name made lowercase.
    class Meta:
        db_table = u'sql_log'
...
class SwfCustomerCreditsTracking0512(models.Model):
    id = models.IntegerField()
    customers_email_address = models.CharField(max_length=765)
    customers_credit = models.DecimalField(null=True, max_digits=21, decimal_places=4, blank=True)
    customers_promocode = models.CharField(max_length=765, blank=True)
    customers_credit_type = models.CharField(max_length=765, blank=True)
    class Meta:
        db_table = u'swf_customer_credits_tracking_0512'

class SwfCustomerCreditsTrackingBackup(models.Model):
    id = models.IntegerField(primary_key=True)
    customers_email_address = models.CharField(max_length=765)
    customers_credit = models.DecimalField(null=True, max_digits=21, decimal_places=4, blank=True)
    customers_promocode = models.CharField(max_length=765, blank=True)
    customers_credit_type = models.CharField(max_length=765, blank=True)
    class Meta:
        db_table = u'swf_customer_credits_tracking_backup'

class SwfInventoryTracking(models.Model):
    id = models.IntegerField(primary_key=True)
    trackingdate = models.DateTimeField(null=True, db_column='TrackingDate', blank=True) # Field name made lowercase.
    product_count = models.IntegerField(null=True, blank=True)
    product_stock = models.IntegerField(null=True, blank=True)
    supplies_count = models.IntegerField(null=True, blank=True)
    supplies_stock = models.IntegerField(null=True, blank=True)
    inverts_count = models.IntegerField(null=True, blank=True)
    inverts_stock = models.IntegerField(null=True, blank=True)
    fish_count = models.IntegerField(null=True, blank=True)
    fish_stock = models.IntegerField(null=True, blank=True)
    coral_count = models.IntegerField(null=True, blank=True)
    coral_stock = models.IntegerField(null=True, blank=True)
    class Meta:
        db_table = u'swf_inventory_tracking'
...
class Test(models.Model):
    dd = models.CharField(max_length=3, blank=True)
    class Meta:
        db_table = u'test'
